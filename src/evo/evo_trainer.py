...
def main(args):
    ...
    # print(optimizer.pop)
    # print(optimizer.pop.get("X"))
    # print(optimizer.pop.get("F"))

    # print(f"Initial population {pop_init[0, :10]}")
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        if optimizer.pop is not None and iteration > 1:
            ...
            for i in range(len(pop_X)):
                ...
                pop_loss[i, 0] = loss
                pop_F[i, 0] = args.fitness_ema_beta * pop_F[i, 0] + (1 - args.fitness_ema_beta) * F
                fe_count += 1
