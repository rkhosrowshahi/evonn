...
def main(args):
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for i in range(len(offspring_X)):
            ...
            offspring_F[i, 0] = F
            offspring_l2[i, 0] = l2
            offspring_momentum[i, 0] = F
            fe_count += 1

        # Set individual-specific momentum on the offspring
        offspring.set("momentum", offspring_momentum)

        static = StaticProblem(
            problem, F=offspring_F, loss=offspring_loss, l2=offspring_l2
        )
